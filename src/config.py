    ...
    def __init__(self, dataset, seed=0):
        ...
        default_settings = \
            {'acm': {'alpha': 1, 'dropout': 0, 'fgd_th': 0.8, 'fgh_th': 0.2, 'sem_th': 0.6,
                     'mp_list': ['psp', 'pap', 'pspap'], 'target_type': 'p', 'lens': [5, 5, 1], 'emb_dim': 32, 'com_feat_dim': 16},
             'dblp': {'alpha': 4.5, 'dropout': 0.2, 'fgd_th': 0.99, 'fgh_th': 0.99, 'sem_th': 0.4, 'mp_list': ['apcpa'], 'target_type': 'a', 'lens': [5, 5, 1], 'emb_dim': 256, 'com_feat_dim': 16},
             ...
             'credit': {'alpha': 0.2, 'dropout': 0.2, 'fgd_th': 0.1, 'fgh_th': 0.1, 'sem_th': 0.1, 'mp_list': ['cs'], 'target_type': 'c', 'lens': [10, 3], 'emb_dim': 16, 'com_feat_dim': 8}
             }
