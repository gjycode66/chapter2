...
class HGSL(nn.Module):
    ...
    def __init__(self, cf, g, dataset):
        ...
        with open(current_path + '/results/' + dataset + '/HGSL/random_walk/epoch.pkl', 'rb') as file:
            self.neighbors = pickle.load(file)
        # with open(current_path + '/results/acm/HGSL/random_walk/epoch.pkl', 'rb') as file:
        #     self.neighbors = pickle.load(file)
    ...
    def forward(self, features, adj_ori, mp_emb, e):
        ...
        gcnfeature = self.GCN(features, new_adj)
